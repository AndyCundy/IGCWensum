...
class Hole(models.Model):
    ...
    mens_yards = models.IntegerField(validators=[MaxValueValidator(600), MinValueValidator(1)])
    mens_index = models.IntegerField(validators=[MaxValueValidator(18), MinValueValidator(1)])
    ...
    def __str__(self):
        ...
        return f"Hole {self.number} - {self.course.name if self.course else 'No Course'}"
